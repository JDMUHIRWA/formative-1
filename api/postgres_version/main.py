...
# Create tables (simple approach, OK for this assignment)
models.Base.metadata.create_all(bind=database.engine)

app = FastAPI(title="Earthquake CRUD API")
...
def update_earthquake(earthquake_id: int, eq: schemas.EarthquakeUpdate, db: Session = Depends(get_db)):
